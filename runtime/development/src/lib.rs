...
pub use common_primitives::{AccountId, Nonce, Signature};
...
pub use impls::{AllianceIdentityVerifier, AllianceProposalProvider};
pub use impls::{Author, CreditToBlockAuthor};

/// Define all pallets in the runtime
mod pallets;
pub use pallets::*;

/// Constant values used within the runtime
pub use runtime_common::{constants::currency::*, constants::time::*, *};
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("nativex-chain"),
	impl_name: create_runtime_str!("nativex-chain"),
	authoring_version: 1,
...
/// miner of election provider multi phases.
pub const MINER_MAX_ITERATIONS: u32 = 10;

use sp_runtime::traits::Convert;
pub struct BalanceToU256;
impl Convert<Balance, sp_core::U256> for BalanceToU256 {
	fn convert(a: Balance) -> sp_core::U256 {
		sp_core::U256::from(a)
	}
}
...
impl Convert<sp_core::U256, Balance> for U256ToBalance {
	fn convert(a: sp_core::U256) -> Balance {
		a.try_into().unwrap_or(Balance::max_value())
	}
}
...
construct_runtime!(
	pub struct Runtime
	{
		...
		// This pallet is only intended for testing usage.
...
impl_runtime_apis! {
	...
	impl sp_consensus_babe::BabeApi<Block> for Runtime {
		...
		fn submit_report_equivocation_unsigned_extrinsic(
			equivalent_proof: sp_consensus_babe::EquivocationProof<<Block as BlockT>::Header>,
